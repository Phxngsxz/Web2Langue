    ...
    <div className="min-h-screen px-4 py-16 sm:py-20">
      <div className="container mx-auto">
        ...
        <div className="mb-12 text-center sm:mb-16">
          <h1 className="mb-6 text-3xl font-bold text-gray-900 sm:text-4xl md:text-5xl">{dict.contact.title}</h1>
          <p className="mx-auto max-w-3xl text-lg text-gray-600 sm:text-xl">{dict.contact.subtitle}</p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader>
              <CardTitle className="text-xl sm:text-2xl">{dict.contact.form.submit}</CardTitle>
            </CardHeader>
            <CardContent>
